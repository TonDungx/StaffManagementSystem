...
namespace StaffManagementSystem.Controllers
{
    public class PayrollsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeId,BaseSalary,Bonus,Deductions")] Payroll payroll)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeId,BaseSalary,Bonus,Deductions")] Payroll payroll)
        {
            if (id != payroll.Id)
            {
                return NotFound();
